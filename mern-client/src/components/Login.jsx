...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12 bg-gradient-to-r from-teal-200 to-cyan-400">
			...
			<div className="max-w-md mx-auto">
				...
				<div className="divide-y divide-gray-200">
					<form onSubmit={handleLogin} className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                        ...
                        {error ? <p className='text-red-600 text-base'>"This email address does not exist or the password is Incorrect.Try again"</p> : ""}
                        <p>If you haven't an account. Please <Link to="/sign-up" className='text-blue-700 underline'>Sign Up</Link> Here</p>
						<div className="relative">
							<button className="bg-teal-500 hover:bg-orange-700 text-white rounded-md px-6 py-2">Log in</button>
						</div>
					</form>
				</div>
