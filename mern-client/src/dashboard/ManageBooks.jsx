  ...
  return (
    <div className='px-4 my-12'>
      <h2 className='mb-8 text-3xl font-bold'></h2>
        ...
        {/* table for book data */}
        <Table className='lg:w-[1180px] bg-gray-100 border-gray-300'>
        <Table.Head className="blackspace-nowrap font-medium text-gray-900 dark:text-black bg-gray-100 border-gray-300">
        ...
        </Table.Head>
        {
          allBooks.map((book, index) =>  <Table.Body className="divide-y"key={book._id}>
             <Table.Row>
            <Table.Cell className="blackspace-nowrap font-medium text-gray-900 dark:text-black">
              {index+1}
            </Table.Cell>
            <Table.Cell className="blackspace-nowrap font-medium text-gray-900 dark:text-black">
              {book.bookTitle}
            ...
            <Table.Cell>Rs.899.00</Table.Cell>
            <Table.Cell>
